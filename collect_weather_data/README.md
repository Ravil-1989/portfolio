...
### Общий вывод
---
В результате выполнения проекта созданы дашборды в Yandex DataLens с визуализацией погодных данных, работающие на базе Postgre SQL сервера. Дашборды можно посмотреть по <a href='https://datalens.yandex/fe071bz8rmjg0?tab=pLM'>ссылке</a>.
